...
// // ex9 = ((x^y)^F)
// Expression ex9 = new Xor(new Xor(new Var("x"), new Var("y")), new
// Val(false));
// // simplify(ex9) = (x^y)
...
// // ex11 ((x^y)^T)
// Expression ex11 = new Xor(new Xor(new Var("x"), new Var("y")), new
// Val(true));
// // simplify(ex11) = ~(x^y)
...
// // ex13 = ((x A y) A F)
// Expression ex13 = new Nand(new Nand(new Var("x"), new Var("y")), new
// Val(false));
// // simplify(ex13) = T
// assertEquals(ex13.simplify().toString(), "T");
// // ex14 = ((x A y) A T)
// Expression ex14 = new Nand(new Nand(new Var("x"), new Var("y")), new
// Val(true));
// // simplify(ex14) = ~(x A y)
...
// // ex17 = ((x V y) V F)
// Expression ex17 = new Nor(new Nor(new Var("x"), new Var("y")), new
// Val(false));
// // simplify(ex17) = ~((x V y))
// assertEquals(ex17.simplify().toString(), "~((x V y))");
// // ex18 = ((x V y) V T)
// Expression ex18 = new Nor(new Nor(new Var("x"), new Var("y")), new
// Val(true));
// // simplify(ex18) = F
// assertEquals(ex18.simplify().toString(), "F");
// // ex19 = ((x V y) V (x V y))
// Expression ex19 = new Nor(new Nor(new Var("x"), new Var("y")), new Nor(new
// Var("x"), new Var("y")));
// // simplify(ex19) = ~((x V y))
// assertEquals(ex19.simplify().toString(), "~((x V y))");
// // same tests for XNOR
// // ex20.5 And(Xnor(x, x), y) ⇒ y
// Expression ex205 = new And(new Xnor(new Var("x"), new Var("x")), new
// Var("y"));
// // simplify(ex205) = y
// assertEquals(ex205.simplify().toString(), "y");
// // ex20 = ((x # x) # (y # y))
// Expression ex20 = new Xnor(new Xnor(new Var("x"), new Var("x")), new Xnor(new
// Var("y"), new Var("y")));
// // simplify(ex20) = T
// assertEquals(ex20.simplify().toString(), "T");
// // Repeat all tests but opposite side in the expression
// // ex21 = ((1&x)&x)
// Expression ex21 = new And(new And(new Val(true), new Var("x")), new
// Var("x"));
// // simplify(ex21) = x
// assertEquals(ex21.simplify().toString(), "x");
// // ex22 = ((0&x)&x)
// Expression ex22 = new And(new And(new Val(false), new Var("x")), new
// Var("x"));
// // simplify(ex22) = F
...
// // ex27 = (F^(x^y))
// Expression ex27 = new Xor(new Val(false), new Xor(new Var("x"), new
// Var("y")));
// // simplify(ex27) = (x^y)
// assertEquals(ex27.simplify().toString(), "(x ^ y)");
// // ex28 = (T^(x^y))
// Expression ex28 = new Xor(new Val(true), new Xor(new Var("x"), new
// Var("y")));
// // simplify(ex28) = ~(x^y)
// assertEquals(ex28.simplify().toString(), "~((x ^ y))");
// // ex30 = (x^(y^T))
// Expression ex30 = new Xor(new Var("x"), new Xor(new Var("y"), new
// Val(true)));
// // simplify(ex30) = (x ^ ~(y))
// assertEquals(ex30.simplify().toString(), "(x ^ ~(y))");
// // ex31 = (x^(y^F))
// Expression ex31 = new Xor(new Var("x"), new Xor(new Var("y"), new
// Val(false)));
// // simplify(ex31) = (x^y)
...
// Expression ex32 = new Or(new And(subExpression, subExpression), new
// And(subExpression, subExpression));
// // simplify(ex32) = (x&y)
// assertEquals(ex32.simplify().toString(), "(x & y)");
// // ex33 = ((x&y)&(x&y)) | ((x&y)&F)
// Expression ex33 = new Or(new And(subExpression, subExpression), new
// And(subExpression, new Val(false)));
// // simplify(ex33) = (x&y)
// assertEquals(ex33.simplify().toString(), "(x & y)");
// // ex34 = ((x&y)&(x&y)) | ((x&y)&T)
// Expression ex34 = new Or(new And(subExpression, subExpression), new
// And(subExpression, new Val(true)));
// // simplify(ex34) = (x&y)
...
// Expression ex35 = new Nor(new Nand(subExpression, subExpression), new
// Nand(subExpression, subExpression));
// // simplify(ex35) = ~(~(x^y))
// assertEquals(ex35.simplify().toString(), "~(~((x ^ y)))");
// // ex36 = ((x^y) A (x^y)) V ((x^y) A F)
// // ex36 = (~(x^y)) V T
// Expression ex36 = new Nor(new Nand(subExpression, subExpression), new
// Nand(subExpression, new Val(false)));
// // simplify(ex36) = F
